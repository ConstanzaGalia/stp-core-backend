-- Capturas con puntos de pose del Functional Screening Biomecánico STP
-- La imagen se guarda limpia en Storage; `landmarks` permite dibujar el esqueleto al renderizar.
