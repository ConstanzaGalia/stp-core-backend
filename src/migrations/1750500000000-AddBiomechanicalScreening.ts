...
export class AddBiomechanicalScreening1750500000000 implements MigrationInterface {
  name = 'AddBiomechanicalScreening1750500000000';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP TABLE IF EXISTS biomechanical_screening_test_result;`);
    await queryRunner.query(`DROP TABLE IF EXISTS biomechanical_screening_session;`);
    await queryRunner.query(`DROP TABLE IF EXISTS biomechanical_screening_protocol;`);
  }
}
